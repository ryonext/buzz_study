...
database_name = case Padrino.env
  when :development then 'fluent'
  when :production  then 'buzz_study_production'
  when :test        then 'buzz_study_test'
end
...
#     sessions:
#       default:
#         database: buzz_study_development
#         hosts:
#           - localhost:27017
#   production:
#     sessions:
#       default:
#         database: buzz_study_production
#         hosts:
#           - localhost:27017
#   test:
#     sessions:
#       default:
#         database: buzz_study_test
#         hosts:
#           - localhost:27017
#
#
